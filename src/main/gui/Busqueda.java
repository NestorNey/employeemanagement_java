...
public class Busqueda extends JFrame {
	 ...
	 */
	public static void main(String[] args, Empleado empleado) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Busqueda frame = new Busqueda(empleado);
	 ...
	 * Create the frame.
	 */
	public Busqueda(Empleado empleado) {
		setResizable(false);
		...
		JLabel nout = new JLabel("Nombres:");
		panel.add(nout);
		
		JLabel nout2 = new JLabel(empleado.getNombre());
		panel.add(nout2);
		
		JLabel lblNewLabel_1 = new JLabel("Apellido Paterno:");
		panel.add(lblNewLabel_1);
		
		JLabel lblNewLabel_1_1 = new JLabel(empleado.getApPate());
		panel.add(lblNewLabel_1_1);
		
		JLabel lblNewLabel_2 = new JLabel("Apellido Materno:");
		panel.add(lblNewLabel_2);
		
		JLabel lblNewLabel_2_1 = new JLabel(empleado.getApMate());
		panel.add(lblNewLabel_2_1);
		
		JLabel lblNewLabel_9 = new JLabel("Departamento:");
		panel.add(lblNewLabel_9);
		
		JLabel lblNewLabel_9_1 = new JLabel(empleado.getDep());
		panel.add(lblNewLabel_9_1);
		
		JLabel lblNewLabel_10 = new JLabel("Puesto:");
		panel.add(lblNewLabel_10);
		
		JLabel lblNewLabel_10_1 = new JLabel(empleado.getPuesto());
		panel.add(lblNewLabel_10_1);
		
		JLabel lblNewLabel_11 = new JLabel("Salario:");
		panel.add(lblNewLabel_11);
		
		JLabel lblNewLabel_11_1 = new JLabel(""+empleado.getSalario());
		...
		JLabel lblNewLabel_3_2 = new JLabel(""+empleado.getdDn());
		panel_1.add(lblNewLabel_3_2);
		
		JLabel lblNewLabel_4 = new JLabel("Mes:");
		panel_1.add(lblNewLabel_4);
		
		JLabel lblNewLabel_4_2 = new JLabel(""+empleado.getmDn());
		panel_1.add(lblNewLabel_4_2);
		
		JLabel lblNewLabel_5 = new JLabel("Año:");
		panel_1.add(lblNewLabel_5);
		
		JLabel lblNewLabel_5_2 = new JLabel(""+empleado.getaDn());
